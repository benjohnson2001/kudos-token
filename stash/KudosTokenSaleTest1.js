...
const KudosToken = artifacts.require('../contracts/KudosToken.sol');
const KudosTokenSale = artifacts.require('../contracts/KudosTokenSale.sol');

contract('KudosTokenSaleTest1', function ([_, investor, wallet, purchaser]) {
  ...
  beforeEach(async function () {
    this.startTime = 1508331600;
    this.endTime =   this.startTime + duration.days(7);
    this.afterEndTime = this.endTime + duration.seconds(1)

    this.token = await KudosToken.new()
    this.crowdsale = await KudosTokenSale.new(token.address)
  })
